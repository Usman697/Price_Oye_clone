...
var brandsName = document.getElementById("brands")
var productsName = document.getElementById("products")
...
function productselect() {
    ...
    console.log("The Selected brand is" + selectedBrand)
...
function itemfound() {
  for(var keys in watches[selectedBrand]){
    ...
    if(watches[selectedBrand][keys].name ===  selectedProduct){
      // console.log(watches[selectedBrand][keys]);
      item.src = watches[selectedBrand][keys].img;
      name1.innerHTML = `${watches[selectedBrand][keys].name}`
      price1.innerHTML = `${watches[selectedBrand][keys].price}`
      category.innerHTML = `${watches[selectedBrand][keys].category}`
    }
    
//     item.innerHTML = `    
//     <h1>${watches[selectedBrand][selectedProduct][keys]}</h1>
// `  
    // console.log(watches[selectedBrand][selectedProduct][keys])
    // console.log(watches[brands][selectedBrand][keys])
  }
}
/////////////////////////////